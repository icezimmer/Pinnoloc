...
from Pinnoloc.models.rnn.vanilla import VanillaGRU, VanillaLSTM, VanillaRNN
from Pinnoloc.deep.stacked import StackedSequenceModel
from Pinnoloc.ml.optimization import setup_optimizer
from Pinnoloc.ml.training import TrainSequenceModel
...
def train(setting, config):
    ...
    try:
        flag = StackedSequenceModel(block_cls=block_factories[block_name], n_layers=1,
    ...
    model = StackedSequenceModel(block_cls=block_factories[block_name], n_layers=deep_args['n_layers'],
    ...
    trainer = TrainSequenceModel(model=model, optimizer=optimizer, criterion=criterion,
