...
def main():
    ...
    hyperparameters = {
        ...
        'num_epochs': [500],
        'lambda_data': (0.0, 1.0),
        'lambda_physics': (0.0, 1.0),
        'lambda_bc': [0.0],
        'n_collocation': [512],
        'n_boundary_collocation': [1],
    ...
    for hyperparameters in tqdm(hyperparameters_list):
        scores = run_ble_position(seed_run, device, develop_dataset, test_dataset, hyperparameters, criterion_to_stratify_develop)
